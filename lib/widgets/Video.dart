              ...
              Column(
                children: <Widget>[
                  ...
                  Stack(
                      ...
                      children: <Widget>[
                        _ButterFlyAssetVideo(),
                       // Image.asset('assets/images/korea_taekwondo_flag.png'),
                      ]),
                ],
              ),
            ])),
...
class _ButterFlyAssetVideoState extends State<_ButterFlyAssetVideo> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/1_taeguk_il_jang.mp4');
...
class _PlayerVideoAndPopPageState extends State<_PlayerVideoAndPopPage> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.asset('assets/videos/1_taeguk_il_jang.mp4');
